...
// import React, { useEffect, useState } from 'react';
// import { Search, Mail, Phone, Building, Briefcase, Building2, Download, FileSpreadsheet, MapPin, UserPlus } from 'lucide-react'; 
// import { useNavigate, useOutletContext } from "react-router-dom";
// import * as XLSX from 'xlsx';
// import { saveAs } from 'file-saver';
...
//     if (memberContext) {
//       const filtered = memberContext.filter(m => 
//         m.memberType?.toLowerCase() === 'referee'
//       );
//       setReferees(filtered);
//     }
//   }, [memberContext]);
...
//       const wb = XLSX.utils.book_new();
//       XLSX.utils.book_append_sheet(wb, ws, "Referees");
//       XLSX.writeFile(wb, "Referees_Directory.xlsx");
//     } else {
//       const csv = XLSX.utils.sheet_to_csv(ws);
...
//                 {member.referrerStatus || "Certified Referee"}
//               </div>
//               <h3>{member.name}</h3>
...
//           <p>No referees found matching your search.</p>
//         </div>
//       )}
//     </div>
//   );
