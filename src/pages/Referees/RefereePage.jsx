...
const RefereePage = () => {
  ...
  return (
    <div className={styles.members}>
      {/* HEADER - Updated to match Mentor page layout */}
      <div 
      ...
      >
        <div className={styles.headerContent}>
          {/* Top Row: Search, Export, Add Referee */}
              ...
              <div className={styles.memberHeader}>
                ...
                <div className={styles.memberInfo}>
                  ...
                  <span style={{ 
                    ...
                    {member.referrerStatus || member.symMemberStatus || "Referee"}
                  </span>
                </div>
              </div>
