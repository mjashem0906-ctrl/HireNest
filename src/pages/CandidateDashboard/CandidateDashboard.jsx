...
const calcCompletion = (m) => {
  ...
  const checks = [
    ...
    has(m.maritalStatus), has(m.linkedinUrl),
  ];
  return Math.round((checks.filter(Boolean).length / checks.length) * 100);
};
...
const CandidateDashboard = () => {
  ...
  const badgeFields = [
    ...
    { label: "Address",      done: !!(ownMember?.address || ownMember?.hometown) },
    { label: "Languages",    done: (ownMember?.languages?.length > 0) },
    { label: "LinkedIn",     done: !!(ownMember?.linkedinUrl) },
  ];
        ...
        <section className={styles.whatsappCard}>
          ...
          <div className={styles.cardInner}>
            <div className={styles.waCardHeader}>
              <div className={styles.waCardIconBox}>
              ...
              <div>
                <h2 className={styles.sectionTitle}>Join Our WhatsApp Community</h2>
                <p className={styles.waCardSub}>Get job updates, tips & networking opportunities</p>
              </div>
            </div>
            ...
            <div className={styles.waGroupCards}>
              {!(parseFloat(ownMember?.workExp) > 0) ? (
                ...
                <div className={`${styles.waGroupCard} ${styles.waGroupCardActive}`}>
                  ...
                  <div className={styles.waGroupCardInfo}>
                    <h4>JBNK Freshers Community</h4>
                    <p>Entry-level jobs, career guidance & mentorship</p>
                  </div>
                  <a
                    href="https://chat.whatsapp.com/LPe6kC4RVjFFqX25uWCKA5"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.waGroupJoinBtn}
                ...
                <div className={`${styles.waGroupCard} ${styles.waGroupCardActive}`}>
                  <div className={styles.waGroupCardIcon}>💼</div>
                  <div className={styles.waGroupCardInfo}>
                    <h4>JBNK Experienced Professionals</h4>
                    <p>Senior roles, referrals & industry insights</p>
                  </div>
                  <a
                    href="https://chat.whatsapp.com/G29SZJqIJzY1J8lAste193"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.waGroupJoinBtn}
                    onClick={(e) => e.stopPropagation()}
