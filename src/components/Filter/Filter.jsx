...
import { Plus, User, Phone, Mail, Calendar, Building, Edit, Trash2,ListFilter,X } from 'lucide-react';
...
function Filter({ fields = [], onApplyFilters, initialValues = {} }) {
  ...
  return (
    <div className={styles.filterWrapper}>
      <button className={styles.addBtn} onClick={() => setShowFilter(!showFilter)}><ListFilter size={24} /></button>
